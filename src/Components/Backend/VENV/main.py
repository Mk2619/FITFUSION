...
backend_path = "C:\\Users\\91709\\Desktop\\my-project\\my-project\\src\\Components\\Backend\\VENV"
...
def start_process(script_path):
    ...
    try:
        # Start the process
        running_process = subprocess.Popen(['C:/Users/91709/anaconda3/python.exe', script_path])
